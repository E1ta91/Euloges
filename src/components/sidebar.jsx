        ...
        <div>
            ...
            <div className='hidden lg:flex flex-col fixed lg:w-[20vw] xl:w-[18vw] 2xl:w-[14vw] mt-5 lg:mt-8 xl:mt-10 ml-2 lg:ml-3 bg-white space-y-6 lg:space-y-8 rounded-xl shadow-sm'>
                ...
                <Link to={'/profile'} className='text-black flex space-x-3 lg:space-x-5 pt-8 lg:pt-12 pl-4 lg:pl-5'>
                    ...
                    }} className='w-11 h-11 lg:w-12 lg:h-12 bg-gray-200 rounded-full' />


                    <p style={{ fontFamily: 'playfair' }} className='pt-2 text-base lg:text-lg'>{user ? user.name : "Loading..."} </p>
                </Link>
            </div>

            {/* Mobile screen view */}
            <div className="lg:hidden w-[100vw] overflow-y-hidden flex justify-between items-center bg-black text-white">
                <h1 className="pl-7 pt-3 text-5xl text-white" style={{ fontFamily: 'fleur' }}>E</h1>
                ...
                <Drawer isOpen={isOpen} setIsOpen={setIsOpen}>
                    ...
                    <DrawNav label={"Explore"} setIsOpen={setIsOpen} setIsModalOpen={setIsSearchBarModalOpen} />
                    <DrawNav label={"Notification"} setIsOpen={setIsOpen} setIsModalOpen={setIsNotificationModalOpen} />
